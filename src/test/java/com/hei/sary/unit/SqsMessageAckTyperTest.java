...
import com.hei.sary.conf.FacadeIT;
import com.hei.sary.endpoint.event.EventConsumer;
import com.hei.sary.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.hei.sary.endpoint.event.gen.UuidCreated", payload);
